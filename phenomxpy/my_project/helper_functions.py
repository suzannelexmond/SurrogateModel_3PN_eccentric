...
# =====================================================================
# [OPTIMIZED #1]: GLOBAL MEMORY MONITORING CONFIGURATION
# Set MEMORY_PROFILE = True to enable live memory monitoring
# Requires: pip install psutil
# =====================================================================
MEMORY_PROFILE = True  # CHANGE TO True FOR LIVE MONITORING

def check_memory_usage(step_name="checkpoint", warning_threshold_mb=8000):
    """[OPTIMIZED #1] Live memory usage monitor."""
    ...
    try:
        ...
        status_marker = '✓' if mem_mb < warning_threshold_mb else '⚠ HIGH MEMORY'
        print(f"[MEM {step_name}]: {mem_mb:.1f} MB {status_marker}")
    except ImportError:
        print("[WARNING] Install psutil for memory monitoring: pip install psutil")
